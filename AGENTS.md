...
- Gemini LLM to understand buyer intent and generate responses
...
3. Backend sends the conversation context to Gemini.
4. Gemini may respond directly or request tool calls.
